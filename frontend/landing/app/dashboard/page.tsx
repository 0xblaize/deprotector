...
export default function Dashboard() {
  ...
  return <main className="dashboard">
    <header className="dash-header"><a href="/" className="dash-brand">DEPROTECTOR</a><nav><a href="/phishing-shield">Phishing shield</a><a href="/auto-revoke">Auto-revoke</a><a className="active" href="/dashboard">Dashboard</a><a href="/extension">Extension</a></nav><button className="connect" onClick={connectWallet}>{wallet ? shorten(wallet) : 'Connect wallet'}</button></header>
