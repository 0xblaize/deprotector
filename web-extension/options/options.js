document.addEventListener("DOMContentLoaded", () => {
  ...
  // Load saved options
  chrome.storage.sync.get(["apiBaseUrl", "dashboardUrl", "blocklistShield", "heuristicShield"], (items) => {
  ...
  saveBtn.addEventListener("click", () => {
    ...
    chrome.storage.sync.set({ apiBaseUrl, dashboardUrl, blocklistShield, heuristicShield }, () => {
